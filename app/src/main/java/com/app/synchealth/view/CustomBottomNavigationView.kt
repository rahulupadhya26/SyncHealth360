...
class CustomBottomNavigationView : BottomNavigationView {
    ...
    private val curveCircleRadius = 128 / 2
    ...
    private fun init() {
        ...
        mPaint!!.color = ContextCompat.getColor(context, R.color.colorBottomBar)
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mFirstCurveEndPoint.set(
            ...
            curveCircleRadius + curveCircleRadius / 4
        )
        ...
        mPath!!.lineTo(mNavigationBarWidth.toFloat(), 0.0f)
        mPath!!.lineTo(mNavigationBarWidth.toFloat(), mNavigationBarHeight.toFloat())
        mPath!!.lineTo(0.0f, mNavigationBarHeight.toFloat())
        mPath!!.close()
    }
